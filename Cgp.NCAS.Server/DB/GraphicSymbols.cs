...
{
    public sealed class GraphicSymbols :
        ANcasBaseOrmTable<GraphicSymbols, GraphicSymbol>, 
        IGraphicSymbols
    {
        private GraphicSymbols() : base(null)
        {
        }
        ...
        {
            get { return Contal.Cgp.Globals.ObjectType.GraphicSymbol; }
        }
    }
}
