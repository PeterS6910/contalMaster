...
{
    [LwSerialize(744)]
    public class CrCardBlockedOrInactiveAlarm : Alarm, ICreateServerAlarm
    {
        private CrCardBlockedOrInactiveAlarm()
        {
        ...
        public ServerAlarm CreateServerAlarm(Guid idCcu)
        {
            ...
            return CrCardBlockedOrInactiveServerAlarm.CreateCrCardBlockedOrInactiveServerAlarm(
                ccu,
                cardReader,
                card,
                new Alarm(
