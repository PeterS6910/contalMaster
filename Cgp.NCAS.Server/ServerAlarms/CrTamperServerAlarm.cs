...
{
    [LwSerialize(823)]
    public class CrTamperServerAlarm : ServerAlarm
    {
        private CrTamperServerAlarm()
        {

        }

        public CrTamperServerAlarm(
            CCU ccu,
        ...
        {
            return DevicesAlarmSettings.Singleton.AlarmCrTamperSabotagePresentationGroup();
        }
    }
}
