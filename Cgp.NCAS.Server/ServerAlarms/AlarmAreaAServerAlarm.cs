...
{
    [LwSerialize(834)]
    public class AlarmAreaAServerAlarm : ServerAlarm
    {
        private AlarmAreaAServerAlarm()
        {
            
        }

        public AlarmAreaAServerAlarm(
            CCU ccu,
            AlarmArea alarmArea,
            ...
            : base(
                new ServerAlarmCore(
                    ...
                    ccu.Name,
                    string.Format(
                        "Alarm area '{0}' is in A-alarm, count of sensors in alarm: {1}",
                        alarmArea.ToString(),
