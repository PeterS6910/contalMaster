...
{
    [LwSerialize(838)]
    public class InputTamperServerAlarm : ServerAlarm
    {
        private InputTamperServerAlarm()
        {
            
        }

        public InputTamperServerAlarm(
            CCU ccu,
            Input input,
            Alarm alarm)
            : base(
        ...
        public override PresentationGroup GetPresentationGroup()
        {
            ...
            return input != null
                ? input.TamperAlarmPresentationGroup
                : null;
        }
    }
}
