...
{
    [LwSerialize(828)]
    public class CrInvalidCodeServerAlarm : ServerAlarm
    {
        private CrInvalidCodeServerAlarm()
        {

        }

        public CrInvalidCodeServerAlarm(
            CCU ccu,
        ...
        {
            return DevicesAlarmSettings.Singleton.AlarmCrInvalidGinPresentationGroup();
        }
    }
}
