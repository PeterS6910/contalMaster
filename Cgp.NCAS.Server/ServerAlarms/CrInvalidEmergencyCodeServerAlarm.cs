...
{
    [LwSerialize(829)]
    public class CrInvalidEmergencyCodeServerAlarm : ServerAlarm
    {
        private CrInvalidEmergencyCodeServerAlarm()
        {

        }

        public CrInvalidEmergencyCodeServerAlarm(
            CCU ccu,
            ...
            : base(
                new ServerAlarmCore(
                    ...
                    ccu.Name,
                    string.Format(
                        "Invalid emergency code on card reader {0}",
                        cardReader.ToString())))
        {
        ...
        {
            return DevicesAlarmSettings.Singleton.AlarmCrInvalidEmergencyCodePresentationGroup();
        }
    }
}
