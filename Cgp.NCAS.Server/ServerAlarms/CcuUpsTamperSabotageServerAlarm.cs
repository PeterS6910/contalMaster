...
{
    [LwSerialize(811)]
    public class CcuUpsTamperSabotageServerAlarm : ServerAlarm
    {
        private CcuUpsTamperSabotageServerAlarm()
        {

        }

        public CcuUpsTamperSabotageServerAlarm(
            CCU ccu,
            Alarm alarm)
            : base(
                new ServerAlarmCore(
        ...
        {
            return DevicesAlarmSettings.Singleton.AlarmCcuUpsTamperSabotagePresentationGroup();
        }
    }
}
