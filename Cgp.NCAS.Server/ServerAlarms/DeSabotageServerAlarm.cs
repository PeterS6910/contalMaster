...
{
    [LwSerialize(820)]
    public class DeSabotageServerAlarm : ServerAlarm
    {
        private DeSabotageServerAlarm()
        {

        }

        public DeSabotageServerAlarm(
            CCU ccu,
            ...
            : base(
                new ServerAlarmCore(
                    ...
                    ccu.Name,
                    string.Format(
                        "Door environment '{0}' is in sabotage, sensor is in tamper",
        ...
        public override PresentationGroup GetPresentationGroup()
        {
            ...
            return doorEnvironment != null && doorEnvironment.SabotagePresentationGroup != null
                ? doorEnvironment.SabotagePresentationGroup
                : DevicesAlarmSettings.Singleton.AlarmDeSabotagePresentationGroup();
        }
    }
}
