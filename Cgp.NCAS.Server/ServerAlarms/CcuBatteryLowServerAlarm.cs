...
{
    [LwSerialize(806)]
    public class CcuBatteryLowServerAlarm : ServerAlarm
    {
        private CcuBatteryLowServerAlarm()
        {

        }

        public CcuBatteryLowServerAlarm(
            CCU ccu,
            Alarm alarm)
            : base(
                new ServerAlarmCore(
        ...
        {
            return DevicesAlarmSettings.Singleton.AlarmCcuBatteryIsLowPresentationGroup();
        }
    }
}
