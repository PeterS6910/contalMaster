...
{
    [LwSerialize(827)]
    public class CrInvalidPinServerAlarm : ServerAlarm
    {
        private CrInvalidPinServerAlarm()
        {
        ...
        public static CrInvalidPinServerAlarm CreateCrInvalidPinServerAlarm(
            CCU ccu,
            CardReader cardReader,
            Card card,
            Alarm alarm)
        {
            var description = string.Format(
                "Invalid PIN on card reader: {0} for card: {1}",
                cardReader.ToString(),
            ...
            return new CrInvalidPinServerAlarm(
                ccu,
                cardReader,
                card,
                alarm,
        ...
        {
            return DevicesAlarmSettings.Singleton.AlarmCrInvalidPinPresentationGroup();
        }
    }
}
