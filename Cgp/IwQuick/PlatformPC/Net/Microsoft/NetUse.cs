...
namespace Contal.IwQuick.Net.Microsoft
{
    public class NetUse
    {
        ...
        public static void UnmapDrive(string drive, bool isForce, bool isPersistent)
        {
            ...
            int iExitCode = DllMpr.WNetCancelConnection2A(drive, iFlags, Convert.ToInt32(isForce));
            if (iExitCode > 0)
                throw new System.ComponentModel.Win32Exception(iExitCode);
        }

        public void UnmapDrive(bool isForce)
        {
            UnmapDrive(_drive, isForce, _persistent);
        }
