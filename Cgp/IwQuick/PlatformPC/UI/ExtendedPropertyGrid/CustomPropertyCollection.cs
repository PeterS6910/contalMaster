...
{ 
	[Serializable()]public class CustomPropertyCollection : System.Collections.CollectionBase, ICustomTypeDescriptor
	{
        ...
        public virtual int Add(string strName, object objValue, bool boolIsReadOnly, string strCategory, string strDescription, bool boolVisible, object tag)
        {
            return base.List.Add(new CustomProperty(strName, objValue, boolIsReadOnly, strCategory, strDescription, boolVisible, tag));
        }
        ...
        public virtual CustomProperty this[string Name]
        {
            get
            {
                foreach (CustomProperty item in this.InnerList)
                {
                    if (item.Name == Name)
                    {
                        return item;
