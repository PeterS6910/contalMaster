...
namespace Contal.IwQuick.Data
{
    ...
    {
        private readonly IEnumerator<Tfrom> _originalEnumerator = null;
        ...
        public CastEnumerator([NotNull] IEnumerator<Tfrom> originalEnumerator)
        {
            Validator.CheckForNull(originalEnumerator,"originalEnumerator");
