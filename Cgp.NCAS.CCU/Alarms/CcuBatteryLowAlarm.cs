...
{
    [LwSerialize(737)]
    public class CcuBatteryLowAlarm :
        Alarm,
        ...
        ICreateCatAlarms
    {
        private class CreateAlarmFactoryWhenAlarmWasEnabled : ICreateAlarmFactoryWhenAlarmWasEnabled
        {
            ...
            {
                Events.ProcessEvent(
                    new EventAlarmCcuBatteryIsLow(true));
            }
        }

        public CcuBatteryLowAlarm()
        {

        }

        public CcuBatteryLowAlarm(Guid idCcu)
            : base(
                new AlarmKey(
        ...
        {
            return new EventAlarmOccuredOrChangedCcuBatteryLow(
                true,
                this);
        }
