...
{
    [LwSerialize(751)]
    public class CcuUpsBatteryFuseAlarm :
        Alarm,
        ...
        ICreateCatAlarms
    {
        private class CreateAlarmFactoryWhenAlarmWasEnabled : ICreateAlarmFactoryWhenAlarmWasEnabled
        {
            ...
            Alarm ICreateAlarmFactoryWhenAlarmWasEnabled.CreateAlarm(bool processEvent)
            {
                ...
                return new CcuUpsBatteryFuseAlarm(
                    _idCcu);
            }
            ...
            {
                Events.ProcessEvent(
                    new EventAlarmCcuUpsBatteryFuse(true));
            }
        }

        public CcuUpsBatteryFuseAlarm()
        {

        }

        public CcuUpsBatteryFuseAlarm(Guid idCcu)
            : base(
                new AlarmKey(
        ...
        {
            return new EventAlarmOccuredOrChangedCcuUpsBatteryFuse(
                true,
                this);
        }
